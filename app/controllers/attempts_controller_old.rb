  ...
  before_action :set_record_options, only: [:new, :create, :edit, :update]
  before_action :set_worker_options, only: [:new, :create, :edit, :update]
  before_action :set_observation_options, only: [:new, :create, :edit, :update]
